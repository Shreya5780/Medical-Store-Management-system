<%@ Page Title="" Language="C#" MasterPageFile="~/PharmaSite.master" AutoEventWireup="true" CodeFile="Cart.aspx.cs" Inherits="Cart" %>
            ...
            <div id="dvMain" runat="server">
                <div style="width: 100%;" align="center">
                    <asp:Label ID="lblmess" runat="server" BackColor="#EEEEEE" BorderColor="Black"
                        BorderStyle="Solid" BorderWidth="1px" Font-Bold="false" ForeColor="#4CAF50"
            ...
            <div style="width: 100%;" align="center" id="dvempty" runat="server" visible="false">
                <div>
                    <table cellspacing="2" cellpadding="3" rules="cols" style="background-color: White; border-color: #999999; border-width: 1px; border-style: None; height: 100px; width: 574px;">
                        <tr align="center" style="color: #4CAF50; background-color: #EEEEEE; border-color: Black; border-width: 1px; border-style: Solid; font-size: Large;">
