...
public partial class Order : System.Web.UI.Page
{
    ...
    {
        SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["ePharma"].ConnectionString);
    ...
    protected void ImageButton_Click(object sender, ImageClickEventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ePharma"].ConnectionString);
        ...
        {
            SqlConnection con1 = new SqlConnection(ConfigurationManager.ConnectionStrings["ePharma"].ConnectionString);
        ...
        redirectUrl += "&first_name=ePharma";
        //Product Name
        redirectUrl += "&item_name=Medicines";
        //Product Amount    
        redirectUrl += "&amount=" + lbltotPrice.Text;
        
        redirectUrl += "&business=xyz@yahoo.com";
