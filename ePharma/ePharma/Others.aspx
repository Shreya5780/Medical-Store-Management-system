<%@ Page Title="" Language="C#" MasterPageFile="~/PharmaSite.master" AutoEventWireup="true" CodeFile="Others.aspx.cs" Inherits="Others" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="float: left; width: 120px">
        <fieldset class="fieldsetmain">
            <legend style="font-size: 20px;">Others</legend>
