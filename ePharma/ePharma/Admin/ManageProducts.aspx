<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/PSADMIN.master" AutoEventWireup="true" CodeFile="ManageProducts.aspx.cs" Inherits="Admin_ManageProducts" %>
        ...
        <div>
            ...
            <table align="center">
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:DropDownList ID="ddlcategory" runat="server" Height="17px" Width="99px">
                            ...
                            <asp:ListItem Value="1">Medicines</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td></td>
                </tr>
                <tr>
                    <td>Product Name</td>
                    <td class="auto-style2">
                        <asp:TextBox ID="txtproductname" runat="server" onkeypress="return IsNumeric(event);"  CssClass="green-label" placeholder="Product Name" Width="206px"></asp:TextBox>
                  ...
                  <tr>
                    ...
                    <td class="auto-style2">
                        <asp:DropDownList ID="ddlUnit" runat="server" Height="17px" Width="99px">
                            <asp:ListItem Value="-1">--Select--</asp:ListItem>
                            <asp:ListItem Value="Pack of 6">Pack of 6</asp:ListItem>
                            <asp:ListItem Value="Pack of 10">Pack of 10</asp:ListItem>
                             <asp:ListItem Value="Pack of 12">Pack of 12</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td></td>
                </tr>
        ...
        <div align="center">
            <asp:GridView ID="gvproduct" runat="server" Width="574px" CaptionAlign="Top"
                ...
                <EmptyDataRowStyle BackColor="#eeeeee" BorderColor="Black"
                    BorderStyle="Solid" BorderWidth="1px" Font-Size="Large" ForeColor="#4CAF50"
                    HorizontalAlign="Center" />
                <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
                <HeaderStyle BackColor="#4CAF50" Font-Bold="True" ForeColor="White" />
                <PagerStyle BackColor="#4CAF50" ForeColor="Black" HorizontalAlign="Center" />
